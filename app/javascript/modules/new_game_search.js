...
function displayData(xml) {
  ...
  for (let i = 0; i < x; i += 1) {
    ...
    table += `<tr onclick="getGameData(${xmlDoc.getElementsByTagName('item')[i].getAttribute('id')})"><td>${gameTitle}</td><td>${gameYearPublished}</td></tr>`;
  }
...
// Get details about selected game
